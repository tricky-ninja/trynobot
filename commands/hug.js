module.exports={
    ...
    execute(message, args) {
        ...
        var hugs = ["https://media.tenor.com/images/ecf4840ba6fac22be773e586493d5283/tenor.gif", "https://media.tenor.com/images/bc8e962e6888249486a3e103edd30dd9/tenor.gif", 
        ...
        var hug = Math.floor(Math.random() * hugs.length)
        var hugMsg = ["is hugging", "is embaracing"]
        const loveEmbed = new Discord.MessageEmbed()
            .setAuthor(`${message.author.username} ${hugMsg[Math.floor(Math.random() * hugMsg.length)]} ${taggedUser.username}`)
            .setColor(16732321)
            .setImage(hugs[hug]);
